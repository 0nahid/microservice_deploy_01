...
const generateStudentId = (academicSemester) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const yearStr = ((_a = academicSemester === null || academicSemester === void 0 ? void 0 : academicSemester.year) === null || _a === void 0 ? void 0 : _a.toString()) || '';
    // using substring on the string representation of year
    incrementedId = `${yearStr.substring(2)}${academicSemester.code}${incrementedId}`;
